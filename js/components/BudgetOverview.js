    ...
    return e('div', { className: "bg-slate-800 rounded-xl shadow-lg p-6 border border-slate-700" },
        ...
        e('div', { className: "grid grid-cols-2 md:grid-cols-3 gap-4" },
            e('div', { className: "p-4 bg-blue-900 rounded-lg border border-blue-700" },
                ...
                e('p', { className: "text-xl md:text-2xl font-bold text-blue-400 break-words" }, '$', project.agreedPrice.toLocaleString())
            ),
            ...
            e('div', { className: "p-4 bg-indigo-900 rounded-lg border border-indigo-700" },
                ...
                e('p', { className: "text-xl md:text-2xl font-bold text-indigo-400 break-words" }, '$', metrics.adjustedPrice.toLocaleString())
            ),
            e('div', { className: "p-4 bg-orange-900 rounded-lg border border-orange-700" },
                ...
                e('p', { className: "text-xl md:text-2xl font-bold text-orange-400 break-words" }, '$', metrics.totalMaterials.toLocaleString())
            ),
            e('div', { className: "p-4 bg-pink-900 rounded-lg border border-pink-700" },
                e('p', { className: "text-sm text-pink-300 mb-1" }, 'Labor Cost'),
                e('p', { className: "text-xl md:text-2xl font-bold text-pink-400 break-words" }, '$', metrics.totalLaborCost.toLocaleString())
            ),
            e('div', { className: "p-4 bg-cyan-900 rounded-lg border border-cyan-700" },
                ...
                e('p', { className: "text-xl md:text-2xl font-bold text-cyan-400 break-words" }, '$', metrics.totalTravelExpenses.toFixed(2))
            ),
            ...
            e('div', { className: "p-4 bg-teal-900 rounded-lg border-2 border-teal-600" },
                ...
                e('p', { className: "text-xl md:text-2xl font-bold text-teal-400 break-words" }, '$', metrics.totalPayments.toLocaleString())
            ),
            e('div', { className: "p-4 bg-amber-900 rounded-lg border-2 border-amber-600" },
                ...
                e('p', { className: "text-xl md:text-2xl font-bold text-amber-400 break-words" }, '$', metrics.outstandingBalance.toLocaleString())
            )
        )
    );
}
